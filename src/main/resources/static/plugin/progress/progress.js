...
Dial.prototype.animateStart = function(score) {
	var v = 0;
    var self = this;
...
Dial.prototype.setValue = function(value, score) {	
		var c = (value / 100) * 360;
		if(c === 360)
			c = 359.99;
    ...
    this.text.innerHTML = Math.floor(score) + '<tspan font-size="' + tspanSize + '" dy="' + -tspanSize * 1.2 + '">%</tspan>';
};